    ...
    <UiDialogContent class="w-[92vw] rounded-md">
      <UiDialogHeader>
        ...
        <UiDialogDescription class="text-left">
          <p>· 投稿之前请在首页搜索查看是否有其他人投了这首歌哦！留言可以随歌曲一起提交</p>
          <p>· 收集班级和姓名是为了方便定位稿件来源，实际后台审核时只能看到年级，无法看到姓名与班级</p>
          <p>· 提交的班号不存在将直接拒绝投稿，初中部同学请选择 其他年级 1班</p>
        </UiDialogDescription>
      </UiDialogHeader>
          ...
          <!-- <UiFormField v-slot="{ componentField }" name="musicapp">
            <UiFormItem>
              ...
              <UiSelect v-bind="componentField">
                ...
                <UiSelectContent>
                  <UiSelectGroup>
                    <UiSelectItem value="qq">
                      QQ音乐
                    </UiSelectItem>
                    <UiSelectItem value="163">
                      网易云音乐
                    </UiSelectItem>
                  </UiSelectGroup>
                </UiSelectContent>
